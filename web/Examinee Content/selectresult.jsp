...
%>
 <%
              ...
              //MethodClass examObj=new MethodClass();   
            arr=examObj.selectGivenExamRequest(name,email);
      %>
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
								      ...
								      <div class="row">
				<form class="form-horizontal" role="form" action="singleExamResult.jsp" method="post">
                          <h2>
                              <div class="centered">
                            ...
                            <div class="col-sm-6">
                               ...
                               <div class="centered"><button type="submit" class="btn btn-warning btn-lg">
									View Overall Analysis <i class=" fa fa-bar-chart-o"></i> 
                                   </button></div>
                                ...
                                <hr>
                                <br>
                                <a href="examineeOverAllResult.jsp" >  <div class="centered"><button type="submit" class="btn btn-warning btn-lg">
									View All Exam Analysis <i class=" fa fa-bar-chart-o"></i> 
                                        </button></div></a>
